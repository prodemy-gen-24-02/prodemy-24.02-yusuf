            ...
            <div className="p-10 max-w-screen border-2 rounded-lg mx-20 my-10">
                ...
                <div className="grid grid-cols-2 gap-14 p-4">
                    ...
                    <div className="max-w-full">
                        ...
                        <div className="flex justify-between items-center w-full h-fit p-5 border-b-2">
                            <img
                                src={dataCheckout.image}
                            ...
                            <p className="text-xl font-semibold text-black">
                                {NumberFormats.toUsd(dataCheckout.price)}
                            </p>
                        </div>

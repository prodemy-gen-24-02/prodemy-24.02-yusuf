...
const CheckoutProduct = () => {
    const dataCheckout = useSelector((state) => state.cart.data);
                    ...
                    <div className="max-w-full min-w-full">
                        ...
                        <form className="w-full" onSubmit={onClickSubmit}>
                            ...
                            <InputForm
                                label="Address"
                                name="address"
                                placeholder="Street St. No. 1, City, Country"
                                className="w-full mb-5"
                                onChange={onChangeForm}
                            />
                            ...
                            dataCheckout.map((data, index) => (
                                ...
                                >
                                    <img
                                        ...
                                        alt="foto produk"
                                    />
                                    <h3 className="text-xl font-semibold text-black text-wrap max-w-14">
                                        {data.nama}
                                    </h3>
